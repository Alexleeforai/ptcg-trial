...
async function fetchMinHkdFromUsedListings(tradingCardId) {
    const bases = [
        `https://snkrdunk.com/en/v1/trading-cards/${tradingCardId}/used-listings?perPage=80&page=1&sortType=1&isOnlyOnSale=true`,
        `https://snkrdunk.com/en/v1/trading-cards/${tradingCardId}/used-listings?perPage=80&page=1&sortType=1&isOnlyOnSale=false`
    ];
