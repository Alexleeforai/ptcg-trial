                ...
                <div className={styles.grid}>
                    {filtered.map((card) => (
                        <CollectionCard
                            ...
                            set={card.set}
                            priceJpy={card.price}
                            snkrdunkProductId={card.snkrdunkProductId}
                            snkrdunkPricePSA10={card.snkrdunkPricePSA10}
                            snkrdunkPriceUsd={card.snkrdunkPriceUsd}
                            snkrdunkPricePSA10Usd={card.snkrdunkPricePSA10Usd}
